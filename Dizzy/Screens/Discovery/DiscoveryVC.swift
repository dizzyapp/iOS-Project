...
class DiscoveryVC: ViewController, PopupPresenter {
    ...
    private func layoutViews() {
        ...
        nearByPlacesView.snp.makeConstraints { nearByPlacesView in
            ...
            nearByPlacesView.bottom.equalToSuperview().offset(Metrics.triplePadding)
        }
    }
    ...
    private func showPlacesOnHalfScreen() {
        self.nearByPlacesTopConstraint?.update(offset: -self.view.frame.height/2 - 125)
    }
